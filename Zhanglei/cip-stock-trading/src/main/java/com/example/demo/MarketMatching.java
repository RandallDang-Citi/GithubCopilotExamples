...
public class MarketMatching {
    public static void main(String[] args) {
        ...
        buySide.add(new Order("ClientX", 1000)); // ALL or None preference
        buySide.add(new Order("ClientY", 500)); // No preference

        // Sell-side orders
        List<Order> sellSide = new ArrayList<>();
        sellSide.add(new Order("ClientA", 800));
        sellSide.add(new Order("ClientB", 1000));
        sellSide.add(new Order("ClientC", 600));
        sellSide.add(new Order("ClientD", 500));
